...
return (
    <div className='md:flex md:gap-20 w-10/12 mx-auto my-20'>
        <div>
            <img className='hidden md:block' src={loginPic} alt="login photo" />
        </div>
        <div>
            ...
            <div className="">
                <div className="ml-0">
                    <button onClick={handleGoogleSignIn} className='flex justify-center items-center border border-[#f9ae3f] px-20 rounded-3xl'>
